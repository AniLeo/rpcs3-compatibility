			...
			<div id='featured-wrp-block'>
				...
				<div id='featured-tx2-block' class='compat-desc'>
					<p>
						...
						<br>
						There are currently <font color='#27ae60'><b><?php echo countGames('all'); ?></b> tested Game IDs (<b><?php echo getGames(true); ?></b> listed here) </font> and <font color='#e74c3c'><b><?php echo getGames(false); ?></b> untested Game IDs</font>.
						<br>
