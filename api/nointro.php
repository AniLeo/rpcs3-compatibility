...
/*
API v1
Check for the nointro integrity database
...
*/
function exportNoIntroDatabase(string $dat) : array
{
    ...
    */
    ...
    $dat_path = __DIR__."/../nointro-{$dat}.dat";

    if (!ctype_alnum($dat) || !file_exists($dat_path))
    {
